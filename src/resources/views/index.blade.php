                ...
                <div class="table-responsive">
                    <table class="table">
                            ...
                            <tr>
                                ...
                                <td style="width: 200px;">
                                    @if($stripePayment->refunded_amount < $stripePayment->amount)
                                        <button type="button"
                                                class="btn btn-primary btn-block refund-button btn-sm"
                                                data-target="#refund-form{{ $stripePayment->id }}">Refund
                                        </button>
                                        <form action="{{ route('stripe-payments.refund', $stripePayment) }}"
                                              id="refund-form{{ $stripePayment->id }}"
                                              class="refund-form"
                                              method="post">
                                            @csrf
                                            <div class="d-flex">
                                                ...
                                                <input type="number"
                                                       ...
                                                       max="{{ $stripePayment->amount }}"
                                                       value="{{ old('amount') ?? $stripePayment->amount }}">
                                                <button type="submit"
                                                        title="confirm"
                        ...
                        @empty
                            <tr>
                                <td colspan="8"
                                    class="text-center">No Records Found.
                                </td>
                            </tr>
                        @endforelse
                        </tbody>
